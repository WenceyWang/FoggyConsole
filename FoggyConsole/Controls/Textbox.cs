...
namespace DreamRecorder.FoggyConsole.Controls
{
    ...
    public class TextBox : TextualBase
    {
        ...
        public Point CursorPosition
        {
            ...
            set
            {
                var target = ValidateCursor(value);
                ...
                case ConsoleKey.DownArrow:
                    {
                        ...
                        {
                            args.Handled = true;
                            if (Lines[CursorPosition.Y].Length > ActualWidth * ((CursorPosition.X / ActualWidth) + 1))
                            {
                                CursorPosition = new Point(Math.Min(CursorPosition.X + ActualWidth, Lines[CursorPosition.Y].Length), CursorPosition.Y);
                            }
                            else
                            {
