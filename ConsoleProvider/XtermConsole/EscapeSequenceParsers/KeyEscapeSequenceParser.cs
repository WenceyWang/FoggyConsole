        ...
        public void Apply(List<char> content, XtermConsole console)
        {
            ...
            if (match.Success)
            {
                switch (match.Groups[1].Value)
                {
                    ...
                    case "H":
                        {
                            console.InvokeKeyPressed(new ConsoleKeyInfo(default, ConsoleKey.Home, false, false, false));
                            break;
                        }
                    case "F":
                        {
                            console.InvokeKeyPressed(new ConsoleKeyInfo(default, ConsoleKey.End, false, false, false));
                            break;
                        }
                    default:
                        {
